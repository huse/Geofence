...
class SaveReminderFragmentArgs (
    ...
    companion object {
        @JvmStatic
        fun fromBundle(bundle: Bundle): SaveReminderFragmentArgs {
            bundle.setClassLoader(SaveReminderFragmentArgs::class.java.classLoader)
            ...
            return SaveReminderFragmentArgs(__reminder)
        }
    }
}
